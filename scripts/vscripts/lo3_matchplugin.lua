...
function PrintHelp()
    ...
    HC_PrintChatAll_pug("{darkgreen}.help{white} : Ce menu d'aide。")
    HC_PrintChatAll_pug("{white}【Pendant le match】")
    ...
    HC_PrintChatAll_pug("{white}【Pendant le pracc】")
    HC_PrintChatAll_pug("{red}.restart{white} : Restart le pracc、 les scores reviennent à 0。")
    HC_PrintChatAll_pug("{red}.forceend{white} : Force la fin du match/pracc。")
    HC_PrintChatAll_pug("{white}------------------------------------------------")
end
...
function StartPracc()
	...
	SendToServerConsole("sv_showimpacts_time 10")
	SendToServerConsole("sv_infinite_ammo 2")
	SendToServerConsole("mp_buy_anywhere 1")
	SendToServerConsole("sv_cheats 1")
	SendToServerConsole("mp_respawn_on_death_t 0")
